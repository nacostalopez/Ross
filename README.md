...
`tools/agentes/` (Python standard library only, see its README) exports SVG
paths as JSON plus a generated `frontend/agentes/paleta.css`; the browser
...
progress — Alertas, Reportes, Equipo and Auditoría are drawn; Perfil and
